        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:dropdown class="hidden lg:block" position="bottom" align="start">
                ...
                <flux:menu class="w-[220px]">
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('settings.profile')" icon="user" wire:navigate>{{ __('nav.profile') }}</flux:menu.item>
                        <flux:menu.item :href="route('admin.settings')" icon="cog" wire:navigate>{{ __('nav.admin_site_settings') }}</flux:menu.item>
                    </flux:menu.radio.group>
